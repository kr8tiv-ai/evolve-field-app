> **Part of the [Evolved](https://github.com/kr8tiv-ai/evolved) system** — the free, open-source business operating system any service company can stand up for itself. This field app is the crew's **hands**; the [MCP](https://github.com/kr8tiv-ai/evolved) is the brain, the [ops workbook + router](https://github.com/kr8tiv-ai/evolve-ops-workbook) is the spine, and the [owner dashboard](https://github.com/kr8tiv-ai/evolve-dashboard) ([live](https://ops.evolveecoblasting.com)) is the owner's eyes. One complete system, all MIT. Stand up your own: [docs/STAND-UP-YOUR-OWN.md](https://github.com/kr8tiv-ai/evolved/blob/main/docs/STAND-UP-YOUR-OWN.md).
<p align="center">
...
- **A mitigation line for every hazard.** Each hazard the crew taps gets its own *"how did we mitigate it?"* pick (curated options + free-text "Other") — no hazard can be submitted without its documented control.
- **A living document, not a morning form.** The FLHA stays open through the shift: **mid-shift amendments** add new hazards or changed conditions as timestamped, attributed lines (OHS Code §7's "reassess when conditions change" duty), and an **end-of-day sign-off** closes the record — every worker signs out with their own PIN and the owners get a day-summary email including everything that changed. Morning FLHA + amendments + sign-out live on one auditable row.
